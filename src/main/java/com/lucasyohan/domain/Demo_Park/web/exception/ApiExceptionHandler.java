...
public class ApiExceptionHandler {
    ...
    public ResponseEntity<ErrorMessage> cpfUniqueViolationException(RuntimeException ex, HttpServletRequest request) {
        log.warn("Api error - ", ex);
        return ResponseEntity
                .status(HttpStatus.CONFLICT)
                .contentType(MediaType.APPLICATION_JSON)
    ...
    public ResponseEntity<ErrorMessage> passwordNotValidException(RuntimeException ex, HttpServletRequest request) {
        log.warn("Api error - ", ex);
        return ResponseEntity
                .status(HttpStatus.BAD_REQUEST)
                .contentType(MediaType.APPLICATION_JSON)
                .body(new ErrorMessage(request, HttpStatus.BAD_REQUEST, "Senha atual não confere"));
    }
